...
SOURCES += ../cli/cli.cpp ../curve/curve_match.cpp ../curve/tree.cpp ../curve/score.cpp ../curve/incr_match.cpp ../curve/functions.cpp ../curve/thread.cpp ../curve/multi.cpp ../curve/scenario.cpp ../curve/kb_distort.cpp ../curve/key_shift.cpp
